            ...
            def flush_buffers(target_table=None, force=False):
                for table, data in buffers.items():
                    ...
                    if table == 'ZOiS':
                        ...
                        sql = """INSERT INTO Zapisy (Z_1, Z_2, Z_3, Z_4, Z_5, Z_6, Z_7, Z_8, Z_9, Z_Data, Z_DataMiesiac, Z_NrZapisu, Z_GrupaKont)
                                 VALUES (:Z_1, :Z_2, :Z_3, :Z_4, :Z_5, :Z_6, :Z_7, :Z_8, :Z_9, :Z_Data, :Z_DataMiesiac, :Z_NrZapisu, :Z_GrupaKont)"""
                    elif table == 'RPD':
                ...
                if tag.startswith('ZOiS') and tag != 'ZOiS':
                    ...
                    for kz in zapisy_in_block:
                        ...
                        buffers['Zapisy'].append({
                            ...
                            'Z_GrupaKont': z3[:3] if z3 else None
                        })
                    is_target_record = True
